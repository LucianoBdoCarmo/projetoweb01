				...
				<form id="form_edicao" action="atualizar-contato" method="post">
					...
					<div class="row mb-2">
						<div class="col-md-6">
							<label>Nome do contato:</label> <input type="text" name="nome"
								id="nome" class="form-control" value="${contato.nome}"/>
						</div>
						<div class="col-md-3">
							<label>Email:</label> <input type="text" name="email" id="email"
								class="form-control" value="${contato.email}"/>
						</div>
						<div class="col-md-3">
							<label>Telefone:</label> <input type="text" name="telefone"
								id="telefone" class="form-control" value="${contato.telefone}"/>
						</div>
					</div>					
					<div class="row mb-2">
						<div class="col-md-3">
							<label>Data de nascimento:</label> <input type="text"
								name="datanascimento" id="datanascimento" class="form-control" 
					...
					<div class="row mb-2">
						<div class="col-md-12">
							...
							<a href="/projetowev01/admin/consultarcontatos" class="btn btn-light">
