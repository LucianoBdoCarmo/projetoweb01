...
//consultar o contato no banco de dados
			...
			Contato contato = contatoRepository.findById

			(idContato, usuario.getIdUsuario());
	...
	public ModelAndView atualizarContato(HttpServletRequest request) {
		...
		try {
			...
			case 1:
				...
				break;
			case 2:
				contato.setTipo(TipoContato.AMIGOS);
				break;
			case 3:
				contato.setTipo(TipoContato.TRABALHO);
				break;
			case 4:
				contato.setTipo(TipoContato.OUTROS);
				break;
			}
